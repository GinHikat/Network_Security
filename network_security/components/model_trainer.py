...
from network_security.utils.main_utils.utils import load_np,evaluate_models
...
os.environ["MLFLOW_TRACKING_URI"]="https://dagshub.com/GinHikat/Network_Security.mlflow"
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric):
        mlflow.set_registry_uri("https://dagshub.com/GinHikat/Network_Security.mlflow")
    ...
    def init_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            train_arr = load_np(train_file_path)
            test_arr = load_np(test_file_path)
